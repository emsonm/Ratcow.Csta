...
namespace Ratcow.Csta.Avaya.Dmcc
{
    ...
    public interface IDmccCommonDataProtocol
    {
        CSTACommonArguments NewCSTACommonArguments<T>(T value);
        CSTACommonArguments NewCSTACommonArguments(params object[] value);
        CSTACommonArguments NewCSTACommonArguments(XmlElement[] value);

        DmccProtocolType Protocol { get; }
    }
}
