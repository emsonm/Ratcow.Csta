...
namespace Ratcow.Csta.Testbed
{
    class DeviceData
    {
        public DeviceData()
        {
            GetDeviceIdInvokeId = int.MinValue;
            MonitorInvokeId = int.MinValue;
            DeviceId = default(DeviceID);
            MonitorCrossReferenceId = null;
        }

        public int Extension { get; set; }
        public int GetDeviceIdInvokeId { get; set; }
        public DeviceID DeviceId { get; set; }
        public int MonitorInvokeId { get; set; }
        public string MonitorCrossReferenceId { get; set; }
    }
}
